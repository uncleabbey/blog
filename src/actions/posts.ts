...
export const getPosts = (limit: number, page: number) => async (
  dispatch: Dispatch,
) => {
  dispatch({
...
export const addComment = (postId: string, body: string) => async (
  dispatch: Dispatch,
  getState: () => RootState,
) => {
...
export const addPost = ({ title, body }: addPostData) => async (
  dispatch: Dispatch,
  getState: () => RootState,
) => {
  const url = `${baseUrl}`;
...
export const editPost = ({ id, title, body }: addPostData) => async (
  dispatch: Dispatch,
  getState: () => RootState,
) => {
  const url = `${baseUrl}/${id}`;
